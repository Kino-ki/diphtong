...
export default function ReachOutSection() {
  ...
  return (
    <div id="widget" className="flex  relative py-10 lg:py-20 px-5 md:px-10 ">
      <div className="flex flex-col lg:flex-row justify-between md:mt-5 gap-5 lg:gap-0 font-urbanistr  relative">
        <div className="flex flex-col lg:w-1/2 ">
          <h2 className=" text-[2.5rem] lg:text-[5rem] 2xl:text-8xl flex text-center lg:w-[80%] justify-center   lg:mt-3  lg:text-start ">
            {reachout.h2}
          </h2>
